...
class ProfileViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.viewModel = viewModelBuilder(provideViewPresentableInput(), provideEditableViewPresentableInput())
        self.setupUI()
        self.setupBinding()
    }
    ...
    func provideEditableViewPresentableInput() -> UserProfileViewPresentable.EditableInput {
        return (
            hourRateEditTrigger: .empty(),
            personalInfoEditTrigger: .empty()
        )
    }
