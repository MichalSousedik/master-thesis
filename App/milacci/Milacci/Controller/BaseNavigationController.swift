...
class BaseNavigationController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        navigationBarAppearence.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor(named: "Title text")!]
        navigationBarAppearence.largeTitleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor(named: "Title text")!]
