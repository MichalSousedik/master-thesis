...
class UpperCirleCiew: UIView {
    ...
    func create () {
        ...
        let goThroughPoint = CGPoint(x: width/2, y: 0)
        
        let cp = calculateControlPoint(start: CGPoint(x: 0, y: height), goThrough: goThroughPoint, end: endPoint)
